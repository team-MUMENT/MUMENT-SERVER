...
const mumentHistoryCount = (musicId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const historyCount = yield pool_1.default.queryValue(query, [musicId, userId]);
